...
class TranslationService {
  ...
  static final Map<AppLanguage, Map<String, String>> _translations = {
    AppLanguage.english: {
      ...
      'reminder_created_message': 'Reminder created: "{reminderTitle}" at {date}. You will receive a notification in {time}.',
      'failed_to_create_reminder': 'Failed to create reminder',
      'response_paused': '⏸️ Response paused. You can continue the conversation by sending a new message.',
      'document_generated_successfully': 'Document generated successfully!',
      'document_ready_tap_to_open': 'Your document is ready. Tap this message to open the editor and view your document.',
      'error_generating_document': 'Error generating document',
      'sorry_error_generating_document': 'Sorry, I encountered an error while generating your document. Please try again.',
      'generation_stopped_by_user': 'Generation stopped by user',
      'welcome_to_new_chat': 'Welcome to your new chat!',
      'start_typing_message': 'Start typing your message below to begin our conversation',
      'create_document': 'Create Document',
      'create_document_description': 'Get AI-powered help to write and edit documents',
    },
    AppLanguage.spanish: {
      'app_name': 'Eidos',
      ...
      'reminder_created_message': '✅ Recordatorio creado: "{reminderTitle}" el {date}. Recibirás una notificación en {time}.',
      'failed_to_create_reminder': 'Error al crear recordatorio',
      'response_paused': '⏸️ Respuesta pausada. Puedes continuar la conversación enviando un nuevo mensaje.',
      'document_generated_successfully': '¡Documento generado exitosamente!',
      'document_ready_tap_to_open': 'Tu documento está listo. Toca este mensaje para abrir el editor y ver tu documento.',
      'error_generating_document': 'Error al generar documento',
      'sorry_error_generating_document': 'Lo siento, encontré un error al generar tu documento. Por favor intenta de nuevo.',
      'generation_stopped_by_user': 'Generación detenida por el usuario',
      'welcome_to_new_chat': '¡Bienvenido a tu nuevo chat!',
      'start_typing_message': 'Comienza escribiendo tu mensaje abajo para iniciar nuestra conversación',
      'create_document': 'Crear Documento',
      'create_document_description': 'Obtén ayuda impulsada por IA para escribir y editar documentos',
    },
    AppLanguage.french: {
      'app_name': 'Eidos',
      ...
      'creating_chat': 'Création du chat...',
      ...
      'reminder_created_message': '✅ Rappel créé : "{reminderTitle}" le {date}. Vous recevrez une notification dans {time}.',
      'failed_to_create_reminder': 'Échec de la création du rappel',
      'response_paused': '⏸️ Réponse mise en pause. Vous pouvez continuer la conversation en envoyant un nouveau message.',
      'document_generated_successfully': 'Document généré avec succès !',
      'document_ready_tap_to_open': 'Votre document est prêt. Appuyez sur ce message pour ouvrir l\'éditeur et voir votre document.',
      'error_generating_document': 'Erreur lors de la génération du document',
      'sorry_error_generating_document': 'Désolé, j\'ai rencontré une erreur lors de la génération de votre document. Veuillez réessayer.',
      'generation_stopped_by_user': 'Génération arrêtée par l\'utilisateur',
      'welcome_to_new_chat': 'Bienvenue dans votre nouveau chat !',
      'start_typing_message': 'Commencez à taper votre message ci-dessous pour commencer notre conversation',
      'create_document': 'Créer un Document',
      'create_document_description': 'Obtenez de l\'aide alimentée par l\'IA pour écrire et modifier des documents',
    },
    AppLanguage.german: {
      'app_name': 'Eidos',
      ...
      'reminder_created_message': '✅ Erinnerung erstellt: "{reminderTitle}" am {date}. Sie erhalten eine Benachrichtigung in {time}.',
      'failed_to_create_reminder': 'Fehler beim Erstellen der Erinnerung',
      'response_paused': '⏸️ Antwort pausiert. Sie können die Unterhaltung fortsetzen, indem Sie eine neue Nachricht senden.',
      'document_generated_successfully': 'Dokument erfolgreich erstellt!',
      'document_ready_tap_to_open': 'Ihr Dokument ist bereit. Tippen Sie auf diese Nachricht, um den Editor zu öffnen und Ihr Dokument anzuzeigen.',
      'error_generating_document': 'Fehler beim Generieren des Dokuments',
      'sorry_error_generating_document': 'Entschuldigung, beim Generieren Ihres Dokuments ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
      'generation_stopped_by_user': 'Generierung vom Benutzer gestoppt',
      'welcome_to_new_chat': 'Willkommen in Ihrem neuen Chat!',
      'start_typing_message': 'Beginnen Sie unten mit dem Tippen Ihrer Nachricht, um unsere Unterhaltung zu beginnen',
      'create_document': 'Dokument Erstellen',
      'create_document_description': 'Erhalten Sie KI-gestützte Hilfe zum Schreiben und Bearbeiten von Dokumenten',
    },
    AppLanguage.italian: {
      'app_name': 'Eidos',
      ...
      'reminder_created_message': '✅ Promemoria creato: "{reminderTitle}" il {date}. Riceverai una notifica tra {time}.',
      'failed_to_create_reminder': 'Impossibile creare il promemoria',
      'response_paused': '⏸️ Risposta in pausa. Puoi continuare la conversazione inviando un nuovo messaggio.',
      'document_generated_successfully': 'Documento generato con successo!',
      'document_ready_tap_to_open': 'Il tuo documento è pronto. Tocca questo messaggio per aprire l\'editor e visualizzare il tuo documento.',
      'error_generating_document': 'Errore durante la generazione del documento',
      'sorry_error_generating_document': 'Scusa, ho riscontrato un errore durante la generazione del tuo documento. Per favore riprova.',
      'generation_stopped_by_user': 'Generazione interrotta dall\'utente',
      'welcome_to_new_chat': 'Benvenuto nella tua nuova chat!',
      'start_typing_message': 'Inizia a digitare il tuo messaggio qui sotto per iniziare la nostra conversazione',
      'create_document': 'Crea Documento',
      'create_document_description': 'Ottieni aiuto basato sull\'IA per scrivere e modificare documenti',
    },
    AppLanguage.portuguese: {
      ...
      'reminder_created_message': '✅ Lembrete criado: "{reminderTitle}" em {date}. Você receberá uma notificação em {time}.',
      'failed_to_create_reminder': 'Falha ao criar lembrete',
      'response_paused': '⏸️ Resposta pausada. Você pode continuar a conversa enviando uma nova mensagem.',
      'document_generated_successfully': 'Documento gerado com sucesso!',
      'document_ready_tap_to_open': 'Seu documento está pronto. Toque nesta mensagem para abrir o editor e ver seu documento.',
      'error_generating_document': 'Erro ao gerar documento',
      'sorry_error_generating_document': 'Desculpe, encontrei um erro ao gerar seu documento. Por favor, tente novamente.',
      'generation_stopped_by_user': 'Geração interrompida pelo usuário',
      'welcome_to_new_chat': 'Bem-vindo ao seu novo chat!',
      'start_typing_message': 'Comece digitando sua mensagem abaixo para iniciar nossa conversa',
      'create_document': 'Criar Documento',
      'create_document_description': 'Obtenha ajuda baseada em IA para escrever e editar documentos',
    },
  };
